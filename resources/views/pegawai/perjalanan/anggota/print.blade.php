    ...
    <div class="container">
        ...
        <div class="row">
            <table class="table table-bordered border-dark">
                ...
                @foreach($perjalanan->perjalanan->riwayat as $riwayat)
                    <tr>
                        <td>
                            <table class="table-borderless table mt-0 mb-0">
                                <tr>
                ...
                @if($perjalanan->perjalanan->riwayat->count() < 3)

                    @for($i = 0; $i < (3 - $perjalanan->perjalanan->riwayat->count()); $i++)
                        <tr>
                            <td>
                                <table class="table-borderless table mt-0 mb-0">
                                    <tr>
                                        <td style="width: 3%">{{ $sisa[$i] }}</td>
                                        <td style="width: 40%;">
                                            Tiba di
                                            <br>
                                            Pada Tanggal
